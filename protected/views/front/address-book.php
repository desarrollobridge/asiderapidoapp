...
<div class="row bottom10">
  <div class="col-md-6">
    <p class="text-small"><?php echo t("Dirección")?></p>
    <?php 
  ...
  <div class="col-md-6">
    <p class="text-small"><?php echo t("Ciudad")?></p>
...
<div class="row bottom10">
  <div class="col-md-6">
    <p class="text-small"><?php echo t("Estado")?></p>
  ...
  <div class="col-md-6">
    <p class="text-small"><?php echo t("Codigo postal")?></p>
...
<div class="row bottom10">
  <div class="col-md-6">
    <p class="text-small"><?php echo t("Nombre del Lugar")?></p>
  ...
  <div class="col-md-6">
    <p class="text-small"><?php echo t("País")?></p>
	 <?php 
...
<div class="row top10">
  <div class="col-md-2">
  <input type="submit" value="<?php echo t("Enviar")?>" class="green-button medium inline">
  </div>
  <div class="col-md-5">
    <a class="green-text top10 block" href="<?php echo Yii::app()->createUrl('/store/profile/',array(
      'tab'=>2
    ))?>">
	<i class="ion-ios-arrow-thin-left"></i> <?php echo t("Atras")?>
	</a>
  </div>
</div>
...
<table id="table_list" class="table table-striped">
  <thead>
  <tr>
   <th width="40%" ><?php echo Yii::t("default","Dirección")?></th>
   <th ><?php echo Yii::t("default","Nombre del Lugar")?></th>
