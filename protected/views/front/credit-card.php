...
<?php FunctionsV3::sectionHeader('Credit Card information')?>
 ...
 [ <i class="ion-ios-compose-outline"></i> <?php echo t("Agregar nueva tarjeta")?>]
 </a>
...
<div class="top25">
<input type="submit" value="<?php echo t("Agregar nueva tarjeta de credito")?>" class="green-button medium inline block">
</div>
