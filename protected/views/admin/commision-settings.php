...
&nbsp;&nbsp;<?php echo t("Comisión total de orden")?>
</li>
</ul>	


<h3><?php echo t("Comisión Total")?></h3>
<?php  
...
<!--
<h3><?php echo Yii::t("default","Factura")?></h3>
...
<div class="uk-form-row">
  <label class="uk-form-label"><?php echo Yii::t("default","Nombre de Cuenta")?></label>
  <?php 
...
<div class="uk-form-row">
  <label class="uk-form-label"><?php echo Yii::t("default","Numero de Cuenta")?></label>
  <?php 
...
<div class="uk-form-row">
  <label class="uk-form-label"><?php echo Yii::t("default","Plantilla Personalizada")?></label>
  <?php 
...
<div class="uk-form-row">
  <label class="uk-form-label"><?php echo Yii::t("default","Tiempo de Deposito")?></label>
  <?php 
  ...
  ?>
  <span class="uk-text-muted"><?php echo t("Después de la creación de la fecha de factura")?></span>
</div>
...
<input type="submit" value="<?php echo Yii::t("default","Guardar")?>" class="uk-button uk-form-width-medium uk-button-success">
</div>
