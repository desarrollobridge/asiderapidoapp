...
<title>Así de Rápido - Administración</title>
...
<div class="header_wrap">
  <div class="left">
   <h1><img src="http://asiderapido.com/upload/1525612227-website-logo.png" width="125px"></h1>
  </div>
      
  <div class="right">  
      
  <div class="left" style="width:150px;">
  <a target="_blank" class="uk-button" href="<?php echo Yii::app()->createUrl('/')?>/"><i class="fa fa-cutlery"></i> <?php echo t("Ver sitio web")?></a>
  </div>
	...
	<ul class="uk-nav uk-nav-dropdown">
	    <li><a href="<?php echo Yii::app()->request->baseUrl; ?>/admin/profile"><i class="fa fa-user"></i> <?php echo Yii::t("default","Perfil")?></a></li>	    
	    <li><a href="<?php echo Yii::app()->request->baseUrl."/admin/login/logout/true"?>"><i class="fa fa-sign-out"></i> <?php echo Yii::t("default","Salir")?> </a></li>	    
	</ul>
	</div>
	</div>
  ...
  <div class="right">
  <h3 class="uk-button uk-button-danger"><?php echo t("Comisión últimos mes")?>: 
  <span class="commission_total_1 commission_loader"></span>
  </h3>
  </div> <!--end right-->  
  
  <div class="right">
  <h3 class="uk-button uk-button-success"><?php echo t("Comisión hoy")?>: 
  ...
  <div class="right">
  <h3 class="uk-button uk-button-primary"><?php echo t("Comisión total")?>: 
