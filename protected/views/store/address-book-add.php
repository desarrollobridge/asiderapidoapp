...
<a href="<?php echo createUrl("store/addressbook/do/add")?>" class="uk-button"><i class="fa fa-plus"></i> <?php echo Yii::t("default","Agregar nuevo")?></a>
<a href="<?php echo createUrl("store/addressbook")?>" class="uk-button"><i class="fa fa-list"></i> <?php echo Yii::t("default","Lista")?></a>
</div>  
  ...
  <div style="height:20px;"></div>
    ...
    <?php if (Yii::app()->functions->isClientLogin()):?>
      ...
      <div class="uk-form-row">                  
          ...
          ,array(
           'class'=>'uk-width-1-1',
           'placeholder'=>Yii::t("default","Dirección"),
       ...
       <div class="uk-form-row">                  
          ...
          ,array(
           'class'=>'uk-width-1-1',
           'placeholder'=>Yii::t("default","Codigo Zip"),
           'data-validation'=>"required"  
          ))?>
       </div>             
       ...
       <div class="uk-form-row">                  
          ...
          ,array(
           'class'=>'uk-width-1-1',
           'placeholder'=>Yii::t("default","Locación")           
          ))?>
       </div>             
    ...
    <?php else :?> 
    <p class="uk-text-danger"><?php echo Yii::t("default","Perdona, pero debes registrarte primero")?></p>
    <?php endif;?>
