  ...
  <div class="section-label">
    ...
    <div class="row">
       ...
       <div class="col-md-8 col-xs-8 border into-row">
         <a href="javascript:;" class="special-instruction orange-button inline"><?php echo t("Instrucciones")?></a>
       </div>
    </div> <!--row-->
  </div> <!-- section-label--> 
...
<div class="row food-item-actions">
  <div class="col-md-6 col-xs-6 border">
     ...
     class="center upper-text green-button inline"><?php echo t("Atrás")?></a>
              
  </div>
  <div class="col-md-6 col-xs-6 border ">
 
  
  <input type="submit" value="<?php echo empty($row)?Yii::t("default","añadir al carrito"):Yii::t("default","actualizar carrito");?>" 
...
<?php else :?>
<p class="text-danger top25 center"><?php echo t("Disculpa pero no podemos encontrar lo que estas buscando.")?></p>
<?php endif;?>
