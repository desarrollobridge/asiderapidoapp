...
<div class="sections section-grey2 section-orangeform">
  ...
  <div class="box-grey rounded">	     
   ...
   <p class="payment-errors text-danger"></p>
	...
	<div class="row top10">
	  <div class="col-md-3"><?php echo t("Número de Teléfono")?></div>
	  <div class="col-md-8">
	    <?php 
   ...
   <div class="top25">
     ...
     <div class="row top10">
	  ...
	  <div class="col-md-8">
	  <input type="submit" id="africa_submit" value="<?php echo Yii::t("default","Paga ahora")?>" class="black-button inline medium">
	  </div>
	</div>	
