     ...
     <div class="col-md-3 border search-left-content" id="mobile-search-filter">
        ...
        <div class="filter-wrap rounded2 <?php echo $enabled_search_map==""?"no-marin-top":""; ?>">
          ...
          <button type="button" class="close modal-close-btn" data-dismiss="modal" aria-label="Close">
           ...
           <p class="bold"><?php echo t("Filtros")?></p>
         ...
         <div class="result-merchant">
             ...
             <?php if ($data):?>
				 ...
				 ?>
	              ...
	              <?php endforeach;?>     
              <?php else :?>     
              <p class="center top25 text-danger"><?php echo t("Sin resultados con los filtros seleccionados")?></p>
              <?php endif;?>
             ...
             <div class="search-result-loader">
                <i></i>
                <p><?php echo t("Cargando mas Restaurantes...")?></p>
