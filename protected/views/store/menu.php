...
<div class="container">
  <div class="row">
     ...
     <div class="col-md-8 border menu-left-content">
	    ...
	    <ul id="tabs">
		    <li class="active">
		       <span><?php echo t("Menú")?></span>
		       <i class="ion-fork"></i>
		    </li>
		    
		    <?php if ($theme_hours_tab==""):?>
		    <li>
		       <span><?php echo t("Horas de Apertura")?></span>
		       <i class="ion-clock"></i>
		    </li>
		    <?php endif;?>
		    ...
		    <li class="view-reviews">
		       <span><?php echo t("Calificaciones")?></span>
		    ...
		    <li>
		      <span><?php echo t("Información")?></span>
     ...
     <div class="theiaStickySidebar">
      <div class="box-grey rounded  relative">
        ...
        <div class="inner center">
         <button type="button" class="close modal-close-btn" data-dismiss="modal" aria-label="Close">
           <span aria-hidden="true">&times;</span>
            ...
            <p class="bold"><?php echo t("Información de distancia")?></p>
            <?php else :?>
	        <p class="bold"><?php echo t("Información del delivery")?></p>
	        <?php endif;?>
	        ...
	        if(!$search_by_location){
		        if ($distance){
		        	echo t("Distancia").": ".number_format($distance,1)." $distance_type";
		        } else echo  t("Distancia").": ".t("no disponible");
	        }
	        ?>
	        </p>
	        
	        <p class="delivery-fee-wrap">
	        <?php echo t("Tiempo estimado de entrega")?>: <?php echo FunctionsV3::getDeliveryEstimation($merchant_id)?></p>
	        
	        <p class="delivery-fee-wrap">
	        <?php 
	        if(!$search_by_location){
		        if (!empty($merchant_delivery_distance)){
		        	echo t("Distancia de delivery").": ".$merchant_delivery_distance." $distance_type_orig";
		        } else echo  t("Distancia de delivery").": ".t("no disponible");
	        }
	        ?>
	        </p>
	        ...
	        <?php 
	        if ($delivery_fee){
	             echo t("Precio del delivery").": ".FunctionsV3::prettyPrice($delivery_fee);
	        } else echo  t("Precio del delivery").": ".t("Precio del delivery");
	        ?>
	        </p>
        ...
        <div class="inner line-top relative">
           ...
           <p class="bold center"><?php echo t("Tu orden")?></p>
           ...
           <div class="delivery-min">
              <p class="small center"><?php echo Yii::t("default","Subtotal debe ser mayor")?> 
           ...
           <?php endif;?>
	        ...
	        <a href="javascript:;" class="clear-cart">[<?php echo t("Borrar orden")?>]</a>
        ...
        <div class="inner line-top relative delivery-option center">
           ...
           <?php if ($remove_delivery_info==false):?>
             <p class="bold"><?php echo t("Opciones del delivery")?></p>
           <?php else :?>
             <p class="bold"><?php echo t("Opciones")?></p>
           <?php endif;?>
           ...
           <div class="delivery_asap_wrap">            
            ...
            <?php else :?>                       
	         <?php echo CHtml::textField('delivery_time',$now_time,
	          array('class'=>"timepick grey-fields",'placeholder'=>Yii::t("default","Hora de Delivery")))?>
	       <?php endif;?>  	          	  

	          <?php if ( $checkout['is_pre_order']==2):?>         
	          <span class="delivery-asap">
	           <?php echo CHtml::checkBox('delivery_asap',true,array('class'=>"icheck"))?>
	            <span class="text-muted"><?php echo Yii::t("default","Entrega inmediata")?></span>	          
	         </span>       	         	        	     
	         <?php endif;?>    
