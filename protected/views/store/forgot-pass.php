   ...
   <div class="row top30">
    ...
    <div class="inner">
         ...
         <?php echo CHtml::hiddenField('currentController','store')?>
		  ...
		  'placeholder'=>Yii::t("default","Nueva contraseña")
		  ))
		  ?>
		  </div>
		  ...
		  ,array('class'=>"grey-fields full-width",
		   'data-validation'=>"required",
		  'placeholder'=>Yii::t("default","Confirmar contraseña")
		  ))
		  ?>
		  </div>
		  
		  <div class="top10">
		  <input type="submit" value="<?php echo t("Cambiar")?>" class="green-button inline">
		  </div>
