...
<div class="sections section-search-results">
  <div class="container center">
    ...
    <p class="bold">- <?php echo Yii::t("default","Dirección, ciudad, estado")?></p>
    <p class="bold">- <?php echo Yii::t("default","Dirección de Calle y ciudad")?></p>
    <p class="bold">- <?php echo Yii::t("default","Dirección de Calle, código postal")?></p>
  </div> <!--container--> 
