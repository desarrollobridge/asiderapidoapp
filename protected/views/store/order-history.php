<div class="page-right-sidebar">
  ...
  <div class="left-content left">
   <h3><?php echo Yii::t("default","Sus ordenes recientes")?></h3>
       ...
       <?php endforeach;?>
          ...
          <?php if ( $resh=FunctionsK::orderHistory($val['order_id'])):?>                    
               <table class="uk-table uk-table-hover order-order-history show-history-<?php echo $val['order_id']?>">
                 <thead>
                   <tr>
                    <th class="uk-text-muted"><?php echo t("Fecha/Hora")?></th>
                    <th class="uk-text-muted"><?php echo t("Estatus")?></th>
                    <th class="uk-text-muted"><?php echo t("Observaciones")?></th>
                   </tr>
                 </thead>
                 <tbody>
   ...
   <?php endif;?>
   <?php else :?>
   <p class="uk-text-danger"><?php echo Yii::t("default","Necesita iniciar sesion primero.")?></p>
   <?php endif;?>
